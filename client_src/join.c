/*
** join.c for Project-Master in /home/veyssi_b/rendu/tek2/PSU/PSU_2016_myirc
**
...
static char	*make_join(const char *channel)
{
  char		*ret;
  char		*base;
  int		i;
...
int	join(const char **tab, UNUSED const char *src, t_client *client)
{
  char	*command;
